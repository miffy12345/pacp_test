create user U_POWER identified by U_POWER;
/
...
create or replace function U_POWER.p_trim (v VARCHAR2 CHARACTER SET ANY_CS)  return VARCHAR2 CHARACTER SET v%CHARSET
as
begin
return trim(v);
end   p_trim;
...
create or replace function U_POWER.P_REGEXP_REPLACE(srcstr      VARCHAR2 CHARACTER SET ANY_CS,
...
create or replace function U_POWER.
